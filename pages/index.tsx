...
export default function DashboardPage() {
  ...
  const params = useMemo(() => {
    ...
    p.set("limit", "50");
    return p;
  }, [query, category, location, institution, minScore]);
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <div className="mx-auto max-w-6xl p-6">
        ...
        <form onSubmit={onSubmit} className="mb-4 grid grid-cols-1 gap-3 rounded bg-white p-4 shadow sm:grid-cols-2 lg:grid-cols-5">
          <input
            value={query}
                ...
                <div className="flex flex-wrap items-start justify-between gap-2">
                  <div>
                    <div className="mb-1 flex items-center gap-2 text-xs">
                      <span className="rounded bg-slate-200 px-2 py-0.5">{op.source}</span>
